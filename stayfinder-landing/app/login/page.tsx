    ...
    <div className="min-h-screen bg-gradient-to-b from-stayfinder-cream to-white dark:from-indigo-950 dark:to-purple-950 flex items-center justify-center">
      <div className="w-full max-w-md px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-stayfinder-forest/80 dark:text-slate-300">Sign in to continue your journey</p>
        </div>
        ...
        <Card className="border-stayfinder-sage/20 shadow-premium">
          ...
          <CardContent>
            <Button
              className="w-full flex items-center gap-3 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 shadow-sm"

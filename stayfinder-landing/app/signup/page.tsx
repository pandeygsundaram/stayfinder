          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <div className="relative w-16 h-16">
                <div className="absolute inset-0 bg-gradient-to-r from-stayfinder-forest to-stayfinder-sage dark:from-purple-500 dark:to-pink-500 rounded-full opacity-90 blur-[2px]" />
                <div className="absolute inset-[4px] bg-white dark:bg-indigo-950 rounded-full flex items-center justify-center">
                  <Home className="w-8 h-8 text-stayfinder-forest dark:text-purple-400" />
                </div>
              </div>
            </div>
